// core/intelligence/multiTimeframe/m15.js
// M15 Timeframe Analyzer – computes market state for 15‑minute candles.
...
class M15Analyzer extends TimeframeAnalyzer {
  constructor(symbol) {
    super('M15', symbol, 50);
    this.indicators = {
      adxPeriod: 14,
