// core/intelligence/multiTimeframe/h4.js
// H4 Timeframe Analyzer – computes market state for 4‑hour candles.
...
class H4Analyzer extends TimeframeAnalyzer {
  constructor(symbol) {
    super('H4', symbol, 50);
    this.indicators = {
      adxPeriod: 14,
