// core/intelligence/multiTimeframe/m5.js
// M5 Timeframe Analyzer – computes market state for 5‑minute candles.
...
class M5Analyzer extends TimeframeAnalyzer {
  constructor(symbol) {
    super('M5', symbol, 50);
    this.indicators = {
      adxPeriod: 14,
