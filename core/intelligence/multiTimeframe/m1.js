// core/intelligence/multiTimeframe/m1.js
// M1 Timeframe Analyzer – computes market state for 1‑minute candles.
...
class M1Analyzer extends TimeframeAnalyzer {
  constructor(symbol) {
    super('M1', symbol, 50);
    this.indicators = {
      adxPeriod: 14,
  ...
  async analyze(candle = null) {
    ...
    const state = {
      ...
      status: 'confirmed', // M1 candles are confirmed
    };
